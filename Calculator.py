...
Button(root,text="2",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="White",command=lambda:show("2")).place(x=150,y=250)
Button(root,text="3",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="White",command=lambda:show("3")).place(x=290,y=250)
Button(root,text="-",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="White",command=lambda:show("-")).place(x=430,y=250)

Button(root,text="4",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="white",command=lambda:show("4")).place(x=10,y=350)
Button(root,text="5",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="White",command=lambda:show("5")).place(x=150,y=350)
Button(root,text="6",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="White",command=lambda:show("6")).place(x=290,y=350)
Button(root,text="+",width=5,height=1,font=("arail",30,"bold"),bd=1,fg="grey",bg="White",command=lambda:show("+")).place(x=430,y=350)
